...
!define APP_NAME "驻阡陌用户端"
!define APP_EXE "CloudRelayUser.exe"
!define PROCESS_BASENAME "CloudRelayUser"
!define INSTALLER_QUIT_ARG "--quit-for-install"
!define INSTALL_DIR_DEFAULT "$LOCALAPPDATA\CloudRelayUser"
!define UNINSTALL_REG_PATH "Software\Microsoft\Windows\CurrentVersion\Uninstall\CloudRelayUserDesktop"
!define RUN_REG_PATH "Software\Microsoft\Windows\CurrentVersion\Run"
!define RUN_VALUE_NAME "CloudRelayUserDesktop"
...
Section "Install"
  ...
  SetOutPath "$INSTDIR"
  File "${PAYLOAD_DIR}/CloudRelayUser.exe"
