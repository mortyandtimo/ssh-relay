...
type UserServiceEntry struct {
	...
	P2PBootstrap       *ServiceP2PBootstrap      `json:"p2pBootstrap,omitempty"`
}
...
type ServiceP2PBootstrap struct {
	Provider       string   `json:"provider"`
	NetworkName    string   `json:"networkName,omitempty"`
	NetworkSecret  string   `json:"networkSecret,omitempty"`
	Peers          []string `json:"peers,omitempty"`
	Hostname       string   `json:"hostname,omitempty"`
	InstanceName   string   `json:"instanceName,omitempty"`
	PrivateMode    bool     `json:"privateMode"`
	OverlayBaseURL string   `json:"overlayBaseUrl,omitempty"`
}
